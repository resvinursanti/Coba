...
{
    public partial class Kerucut : Form
    {
        public Kerucut()
        {
            InitializeComponent();
        ...
        public double V, L, rv, tv, la, ls, pi;
        private void button1_Click(object sender, EventArgs e)
        {
            la = Convert.ToDouble(textBox1.Text);
            ls = Convert.ToDouble(textBox3.Text);
            L = la + ls;
        ...
        {
            pi = 22 / 7;
            rv = Convert.ToDouble(textBox9.Text);
            tv = Convert.ToDouble(textBox7.Text);
            V = 3 / pi * rv * rv * tv;
