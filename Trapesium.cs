...
{
    public partial class Trapesium : Form
    {
        public Trapesium()
        {
            InitializeComponent();
        ...
        private double a, b, t, ak, bk, ck, dk, L, K;
        ...
        {
            ak = Convert.ToDouble(textBox4.Text);
            bk = Convert.ToDouble(textBox5.Text);
            ck = Convert.ToDouble(textBox8.Text);
            dk = Convert.ToDouble(textBox9.Text);
            K = ak + bk + ck + dk;
