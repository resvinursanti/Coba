...
{
    public partial class Tabung : Form
    {
        public Tabung()
        {
            InitializeComponent();
        ...
        public double L, rl, dl, tl, V, vr, vt,pi ;
        private void button1_Click(object sender, EventArgs e)
        {
            rl = Convert.ToDouble(textBox1.Text);
            dl = Convert.ToDouble(textBox3.Text);
            tl = Convert.ToDouble(textBox4.Text);
            if (rl % 7 != 0)
            {
                L = (2 * (3.14 * rl * rl)) + (3.14 * dl * tl);
            }
            else
            {
                L = (2 * ((22 * (rl / 7)) * rl)) + ((22 * (dl / 7)) * tl);
            }
        ...
        {
            vr = Convert.ToDouble(textBox9.Text);
            vt = Convert.ToDouble(textBox7.Text);
            if (rl % 7 != 0)
            {
                V = 3.14 * vr * vr * vt;
            }
